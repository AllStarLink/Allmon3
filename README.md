...
2. Install Allmon3
```
wget https://github.com/AllStarLink/Allmon3/releases/download/rel_t_0_11_6/allmon3_0.11.6-1_all.deb
dpkg -i allmon3_0.11.6-1_all.deb
```
...
```
wget https://github.com/AllStarLink/Allmon3/releases/download/rel_t_0_11_6/allmon3_0.11.6-1_deb10.deb
dpkg -i allmon3_0.11.6-1_deb10.deb
```
