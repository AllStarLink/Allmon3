...
2. Install Allmon3
```
wget https://github.com/AllStarLink/Allmon3/releases/download/rel_t_0_11_1/allmon3_0.11.1-1_debian11.deb
dpkg -i allmon3_0.11.0-1_debian11.deb
```
...
```
wget https://github.com/AllStarLink/Allmon3/releases/download/rel_t_0_11_1/allmon3_0.11.1-1_debian11.deb
dpkg -i allmon3_0.11.1-1_debian11.deb
```
